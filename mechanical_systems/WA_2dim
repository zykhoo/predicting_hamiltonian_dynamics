# weighted average uses the weighted average of all sample derivatives to predict the next derivative
# weights are generated using inverse distance metric
